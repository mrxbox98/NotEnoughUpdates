...
public class DarkMonolith {
    ...
    public void onWorldRenderLast(RenderWorldLastEvent event)
    {
        ...
        drawBlock(new BlockPos(100,100,100),event.partialTicks);
    ...
    public static void drawTracerLine(double x, double y, double z, double x2, double y2, double z2, float red, float green, float blue, float alpha, float lineWdith) {
        GL11.glPushMatrix();
